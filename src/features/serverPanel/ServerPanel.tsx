  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-sm text-muted-foreground">
        ...
        Desktop is installed and running, and that{" "}
        <code className="rounded-none bg-muted px-1 py-0.5">docker compose</code>{" "}
    ...
    <div className="flex flex-col gap-4 text-left">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          {!running && (
            <Button size="sm" disabled={busy} onClick={() => startServer(server.id)}>
              <Play />
              Start
            </Button>
          )}
          ...
          <Button size="sm" variant="destructive" disabled={busy} onClick={handleRemove}>
            <Trash2 />
            Remove
          </Button>
        </div>
